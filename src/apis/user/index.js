...
export const getManagerClass = (params) => {
    return get(baseUrl + '/getManagerClass', params)
}

export const updateManagerClassroom = (params) => {
    return put(baseUrl + '/updateManagerClassroom', params)
}